      ...
      <Stack direction="row" spacing={5}>
        ...
        <Stack>
          <Button
            variant="contained"
            color="error"
            onClick={errorActionHandleClick}
          >
            error Snackbar
          </Button>
          <Snackbar
        ...
        <Stack>
          <Button
            variant="contained"
            color="warning"
            onClick={warningActionHandleClick}
          >
            warning Snackbar
          </Button>
          <Snackbar
        ...
        <Stack>
          <Button
            variant="contained"
            color="success"
            onClick={successActionHandleClick}
          >
            success Snackbar
          </Button>
          <Snackbar
