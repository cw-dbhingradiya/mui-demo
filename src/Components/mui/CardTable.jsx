              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell padding="none" align="left" sx={{ border: "none" }} variant="body2" align="center" display="flex">
                      <AdbIcon sx={{ color: `grey` }} /> {row.create}
                    </TableCell>
                    <TableCell padding="none" align="left" sx={{ border: "none" }} variant="body2">
                      <MicrosoftIcon sx={{ color: `grey` }} /> {row.stock}
                    </TableCell>
                    <TableCell variant="body2" padding="none" align="left" sx={{ border: "none" }}>
                      {row.price}
                    </TableCell>
                    <TableCell padding="none" align="left" sx={{ border: "none" }}>
                      {row.publish}
                    </TableCell>
                    <TableCell align="left" sx={{ border: "none" }} padding="none">
                      <IconButton>
                        <MoreVertIcon />
                      </IconButton>
                    </TableCell>
