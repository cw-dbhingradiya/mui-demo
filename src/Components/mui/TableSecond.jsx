...
const rows = [
  createData(1, "Deja Brady", "CAP", "$67.55", "Top 1"),
  createData(2, "Esperanza Mcintyre", "Branded Shoes", "$35.71", "Top 2"),
  createData(3, "Jayvion Simon", "Headphone", "$52.84", "Top 3"),
  createData(4, "Deja Brady", "Cell Phone", "$26.92", "Top 4"),
  createData(5, "Chase Day", "Earings", "$58.07", "Top 5"),
];
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Avatar src="https://shorturl.at/rsCJ4" /> {row.name}
                    </TableCell>
                    <TableCell align="left">{row.create}</TableCell>
                    <TableCell align="left" padding="none">
                      <img src={india} width="35" alt="india" />{" "}
                    </TableCell>

                    <TableCell align="left">{row.price}</TableCell>
                    <TableCell align="left">
                      <Button sx={{ color: `error.dark`, bgcolor: "error.soft" }}>{row.publish}</Button>
                    </TableCell>
                  </TableRow>
                );
              })}
